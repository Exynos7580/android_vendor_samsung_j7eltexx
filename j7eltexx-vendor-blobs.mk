...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/proprietary/app/imsservice/imsservice.apk:system/app/imsservice/imsservice.apk \
    $(LOCAL_PATH)/proprietary/app/ImsSettings/ImsSettings.apk:system/app/ImsSettings/ImsSettings.apk \
    $(LOCAL_PATH)/proprietary/lib/libims_engine.so:system/lib/libims_engine.so \
    $(LOCAL_PATH)/proprietary/lib/libcpve-client.so:system/lib/libcpve-client.so \
    $(LOCAL_PATH)/proprietary/lib/libapve-client.so:system/lib/libapve-client.so \
